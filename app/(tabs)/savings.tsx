...
export default function SavingsScreen() {
  const { goals, loading, totalSaved, suggestedAmount, addGoal, updateSaved, deleteGoal, refresh } =
    useSavings();
  ...
  const handleAdd = useCallback(async () => {
    if (!name.trim()) {
      Alert.alert("Invalid", "Enter a goal name");
      return;
    }
    ...
    <View style={{ flex: 1, backgroundColor: "#1E1E2E" }}>
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 10, marginBottom: 16 }}>
          ...
          >
            <Text style={{ color: "rgba(255,255,255,0.8)", fontSize: 12 }}>Total Saved</Text>
          ...
          >
            <Text style={{ color: "#6B7280", fontSize: 12 }}>Suggested Monthly</Text>
            <Text style={{ color: "#00C853", fontSize: 22, fontWeight: "800", marginTop: 4 }}>
